...
Pictures and a framed host session are [`apps/vtty`](../apps/vtty/) (`crt_vtty`), not this UF2. Text there still uses this cell grid. How to open the session and paint a page is [vtty.md](vtty.md).
