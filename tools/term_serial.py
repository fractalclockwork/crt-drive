#!/usr/bin/env python3
"""USB CDC for crt_term: wait for digest banner, HIL UTF-8 line, or interactive TTY."""
...
def main() -> int:
    ...
    parser.add_argument("--digest", default=os.environ.get("TERM_IMAGE_ID", ""))
    parser.add_argument("--timeout", type=float, default=20.0)
    parser.add_argument(
        "--check",
        action="store_true",
        help="wait for crt-term digest= banner and exit",
    )
    parser.add_argument(
        "--hil",
        action="store_true",
        help="banner, send UTF-8 line, expect cursor=0,1",
    )
